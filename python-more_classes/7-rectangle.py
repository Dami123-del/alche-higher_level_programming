#!/usr/bin/python3
"""
This module defines a Rectangle class that tracks instance count
and allows for a customizable print symbol.
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        # Convert print_symbol to string in case it is not one
    ...
    def __del__(self):
        """Decrements instance counter and prints a deletion message."""
        Rectangle.number_of_instances -= 1
        print("Bye rectangle...")
